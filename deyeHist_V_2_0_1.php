...
// ======================= MAIN EXECUTION =======================
try {
    // MODIFIED: Parse dates using ISO 8601 format (e.g., "2025-11-28T17:30:00.000Z")
    $startDt = new DateTime($start);
    $endDt = new DateTime($end);

    if (!$startDt || !$endDt) {
        throw new Exception("Invalid date format. Use ISO 8601 format (e.g., 2025-11-28T17:30:00.000Z)");
    }
