...
function fetchDeyeHistoryPower($stationId, $token_d, $startAt, $endAt) {
    $payload = [
...
try {
    ...
    if ($startTs === false || $endTs === false) {
        throw new Exception("Invalid date format. Use ISO format: YYYY-MM-DDTHH:MM:SSZ");
    }
